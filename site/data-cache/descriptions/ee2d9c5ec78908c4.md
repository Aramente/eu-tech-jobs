...
<li>Prototype, develop, deploy and scale AI solutions tailored to customer needs, including both traditional machine learning and LLM-based solutions</li>
<li>Identify and package scalable AI use cases across the Celonis platform, driving innovation and expanding our offerings</li>
<li>Collect and share AI success stories with the whole organization and our customers</li>
<li>Help define and lead execution on the roadmap for AI Lighthouse customers</li>
<li>Closely collaborate with Product &amp; Engineering and the Business Apps Teams to inform future product development based on customer feedback</li>
<li>Train internal teams and help them position and deploy AI solutions</li>
<li>Design and architecting end-to-end deployments that encompass AI, PI &amp; Automation</li>
</ul>
