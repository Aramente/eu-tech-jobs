...
<p>Elastic is searching for a Senior Public Sector Account Executive (Public Sector Account Executive II) to develop our footprint within UK Defence, specifically the Defence Primes. Our Public Sector Account Executives are focused on expanding current business, building new relationships and growing the Elastic footprint. This role is focused on working with key Defence Primes both B2B and as part of tender teams to ensure they are successfully leveraging Elastic and its solutions across Observability, Search, Security and cloud within their organisations.</p>
<p><strong>What You Will Be Doing:</strong></p>
<ul>
<li>Building awareness and driving demand for Elastic solutions within the Defence Primes by helping users and customers derive value from a range of use cases.</li>
<li>Serving as an evangelist for our Open Source offerings while communicating and demonstrating the capabilities of our commercial features to key stakeholders.</li>
<li>Uncovering new and diverse use cases to enable our users to derive maximum value.</li>
<li>Collaborating across Elastic business functions to ensure a seamless customer experience</li>
<li>Working thoughtfully with customers within the Defence Industrial Base community to identify new business opportunities, manage the sales cycle and close complex transactions.</li>
<li>Building a robust business plan through community, customer and partner ecosystems to achieve significant Elastic growth within your territory</li>
</ul>
<p><strong>What You Bring With You:</strong></p>
<ul>
<li>A track-record of success in selling or Business Development in the Defence market, demonstrated by overachievement of quota and a strong network within Defence and the Defence Primes</li>
<li>A deep understanding and preferably experience selling SaaS, including Enterprise Search, Logging, Security, APM and Cloud</li>
<li>The ability to build relationships and credibility with key stakeholders within the Defence community and the knowledge of how to navigate this unique sector</li>
<li>Ability to apply sales methodologies to support Defence customers and provide accurate and predictable forecasting.</li>
...
<li>A current active security clearance</li>
</ul>
<p><strong>Bonus Points</strong></p>
<ul>
<li>Previous experience working for one of the Defence Primes</li>
