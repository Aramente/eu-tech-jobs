...
- Own infrastructure problems end-to-end — from code to user
- Enable team code quality, speed and deployment processes
- Ensure zero downtime for different environments and projects
- Implement new solutions based on the IaC concept
- Search and implement effective solutions for scaling
...
- Knowledge of Kubernetes and ArgoCD
- GitLab CI/CD expertise
- Experience with SQL databases
- You know what IaC is and how to apply it in practice effectively.
...
- Python or Golang skills.
- Experience with Grafana.

## Tools You Will Use

- Linux, Docker, GitLab, ArgoCD, AWS, Terraform, Helm, OpenSearch, Prometheus, Python / Golang
- **AI tools:** Claude Code, OpenAI Codex, OpenCode, Cursor with Composer

## Salary Range

- Gross salary: 20,500 — 28,400 PLN/month
