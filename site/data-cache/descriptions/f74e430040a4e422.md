...
<ul>
<li>Partner with the Enterprise Sales team to articulate the overall Datadog value proposition, vision and strategy to customers</li>
...
<ul>
<li>5+ years in Sales Engineering, Solutions Engineering, DevOps/SRE, or Platform Engineering, ideally in a customer-facing role</li>
<li>Hands-on experience with at least one major cloud (AWS, Azure, or GCP) and modern app stacks (Containers/Kubernetes, microservices, CI/CD)</li>
<li>Proficient in at least one programming/scripting language (e.g. Java, Python, Go, .NET, JavaScript/Node.js, Ruby, PHP)</li>
<li>Familiar with observability and/or security tooling (metrics, logs, traces, RUM, SIEM, CSPM, etc.); experience with Datadog or similar platforms is a plus</li>
<li>Passionate about educating customers on observability risks that are meaningful to their business, and able to build and execute evaluation plans that clearly articulate both the business value (value proposition) and technical advantages of our offering</li>
<li>Comfortable working across diverse cultures; fluent English required. Proficiency in an additional ASEAN language is advantageous — particularly Cantonese, as the role involves direct customer communication in Hong Kong.</li>
<li>Open to frequent travel to Hong Kong and other locations (via road, train, or air), with travel expected up to 45% of the time.</li>
