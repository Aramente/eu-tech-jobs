<p>私たちは、Datadogの社内プロダクト・エキスパートです。テクニカル・ソリューション・チームは、潜在的な顧客を教育し、既存の顧客を満足させ、成功させることで、Datadogの世界的な成長を可能にしています。私たちは、デモやプレゼンテーション、技術評価、継続的なサポートを通じて、技術や製品に関する専門知識をお客様と共有しています。テクニカル・ソリューションは、知識を共有し、技術的なスキルセットを継続的に向上させるために絶えず協力し合う、成長中のグローバル・チームです。</p>
...
<ul>
<li>複数のチャネル（発券システム、ライブチャット、画面共有ツール）を通じて、プラットフォームの活用方法に関するトレーニングを継続的に実施しつつ、必要な技術サポートを特定し問題解決する</li>
<li>技術的な問題を再現し、Datadogの600以上のインテグレーションを深堀りする</li>
<li>デモ認定資格を取得し、顧客への製品デモをリードする&nbsp;</li>
<li>顧客からのフィードバックに基づき、社内チームとの製品に関するディスカッションに参加する</li>
<li>Datadog製品分野の高度な知識を持つスペシャリストとしてトレーニングを実施</li>
<li>Datadogオフィスにて週3日以上勤務&nbsp;</li>
</ul>
<p>&nbsp;</p>
<p><strong>募集要項：&nbsp;</strong></p>
<ul>
<li>コンピュータ・サイエンス／エンジニアリング専攻および／またはブートキャンプ修了者</li>
<li>オープンソースプロジェクト（コード、バグ報告など）やエンジニアリングコミュニティ（ミートアップなど）への積極的な貢献</li>
<li>自発的で、細部にまで気を配り、継続的に学ぶ意欲のある方&nbsp;</li>
<li>クライアント中心のアプローチをデフォルトとする批判的思考を持つ者</li>
<li>文書および口頭での効果的なコミュニケーション能力</li>
<li>プログラミングの経験があり、Linuxの基本的な知識がある</li>
<li>週末を含むローテーション勤務が可能な方</li>
</ul>
