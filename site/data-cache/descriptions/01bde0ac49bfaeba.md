...
<ul>
<li>
<p>This is an exciting time to join Remote and make a personal difference in the global employment space as a <strong>Senior Business Analyst</strong>, joining our Finance team.</p>
<p>The <strong>Senior Business Analyst</strong><strong>&nbsp;</strong>is a critical member of the Finance Systems Team working in a dynamic, collaborative team environment. The successful candidate will support Global implementation and future support of SAP S/4 HANA&nbsp; Finance functions through business processes definition, analysis of business problems, analytics, proposal/design/configuration/implementation of technical solutions and continued development of the partnership with the wider Remote business areas and 3rd party suppliers.</p>
<p>The ideal candidate will have a demonstrated ability to comprehend business processes and context, while also having technical skills to design and configure appropriate technical solutions.</p>
</li>
</ul>
<h2><strong>What you bring</strong></h2>
<ul>
<li>Proven experience working with SAP in a BA/Functional role.</li>
<li>Experience with SAP FICO essential and with S4 Hana is beneficial.</li>
<li>Proven ability to provide business analysis and system development/configuration deliverables related to process improvement.</li>
<li>Proven knowledge of the software and systems development life cycle</li>
<li>It's not required to have experience working remotely, but considered a plus</li>
</ul>
<h2><strong>Key Responsibilities&nbsp;</strong></h2>
<ul>
<li>Perform complex business and systems analysis work; conduct requirements gathering/analysis via information gathering sessions with business users and technical staff.</li>
<li>Develop supporting process flows.</li>
<li>Conduct analysis of existing business processes; recommend process improvements.</li>
<li>Build and implement new solutions in SAP S/4 HANA related to Finance process improvements.</li>
<li>Develop training materials and conduct training sessions with business users to improve adoption and efficient use of all systems related to the Finance job functions.</li>
<li>Create and manage workflows in SAP S/4 HANA to enhance finance processes.</li>
<li>Assist in the evaluation of third party tools for feasibility and impact to the business.</li>
<li>Design and implement integrations between SAP S/4 HANA and external systems</li>
<li>Create and maintain business requirement documentation which can include use cases, process flows, and system interface diagrams.</li>
<li>Create design documentation based on business requirements.</li>
<li>Communicate effectively with business users on the status of enhancements and projects.</li>
<li>Develop comprehensive test plans with users, coordinate test activities and/or help execute test components.</li>
<li>1st level of support for all finance users and monitoring of all messaging throughput from other financial systems</li>
</ul>
...
<li><strong>Location</strong>: For this position we welcome everyone to apply, but we will prioritize applications from Europe as we encourage our teams to diversify;</li>
