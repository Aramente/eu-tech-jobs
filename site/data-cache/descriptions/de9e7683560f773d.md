...
<p>As a Governance, Risk &amp; Compliance (GRC) Analyst, you will play a central role in shaping and strengthening our security and risk posture. You’ll act as a trusted partner to teams across the business—helping them navigate security decisions, manage risk effectively, and meet compliance requirements without slowing down innovation.</p>
<p>This is a high-impact, high-visibility role within the security team, reporting directly to the CISO. You’ll work at the intersection of security, engineering, and business operations—driving pragmatic, scalable approaches to risk management and compliance.</p>
<p><span style="font-size: 18pt;"><strong>What You'll Do:</strong></span></p>
<ul>
<li>Partner with stakeholders across the business to identify, assess, and drive remediation of security risks</li>
<li>Support and evolve our compliance programmes (e.g. ISO 27001, SOC 2), from evidence gathering through to audit readiness and accreditation</li>
<li>Design, implement, and continuously improve security controls and monitoring practices</li>
<li>Build and automate GRC processes to improve efficiency, accuracy, and scalability</li>
<li>Develop and maintain clear, actionable security policies, standards, and procedures</li>
<li>Provide hands-on support during audits and act as a key point of contact for internal and external assessors</li>
<li>Embed security into business decision-making by providing practical, risk-based guidance</li>
<li>Own and mature vendor risk management across the full lifecycle</li>
<li>Contribute to building a strong security culture through awareness and education initiatives</li>
</ul>
<p><span style="font-size: 18pt;"><strong>What We're Looking For:</strong></span></p>
<ul>
<li>A pragmatic GRC practitioner who understands how to balance risk, security, and business velocity</li>
<li>Experience working with security frameworks such as ISO 27001, SOC 2, HIPAA, PCI DSS, or FedRAMP</li>
<li>Solid understanding of technical security controls and how they are implemented in modern systems</li>
<li>Ability to write code or scripts to automate workflows, analyse data, or improve GRC processes</li>
<li>Experience building dashboards or visualising data to drive insight and decision-making</li>
<li>Exposure to graph technologies (e.g. Neo4j) or an interest in applying them to security and risk problems</li>
<li>Strong communication skills, with the ability to influence both technical and non-technical stakeholders</li>
<li>Confidence in presenting to a range of audiences, including customers and auditors</li>
<li>A growth mindset and a desire to continuously improve both your craft and the way GRC is delivered</li>
</ul>
