...
- Support the planning, coordination, and execution of various events (internal conferences, social events, meetings);
- Assist in event logistics and execution across virtual, live, and hybrid formats;
- Help prepare event materials, timelines, schedules, and communication with guidance from the team;
- Coordinate with internal teams (HR, marketing, leadership) to support smooth event delivery;
- Contribute to event concepts, themes, and creative ideas;
- Assist with on-site event coordination and ensure everything runs smoothly during execution;
- Help track progress and provide updates to the Event Team Lead.
...
- Team player with a positive and solution-oriented mindset.
