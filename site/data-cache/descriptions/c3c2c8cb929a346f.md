...
- Design, build, and maintain automated email flows and lifecycle journeys (onboarding, activation, upsell, cross-sell) using our marketing automation platform.
- Configure triggers, delays and conditional content in the journey builder.
- Manage dynamic segmentation using behavioral and lifecycle data.
- Set up tracking and report on core KPIs including deliverability, open rate, CTR, and conversion.
- Plan and execute A/B tests on subject lines, content, and journey logic; document learnings and implement improvements.
- Collaborate with Product Marketing, Data, and CRM teams to align lifecycle communications with key customer milestones and business goals.

## Core Requirements

- Hands-on experience in email or lifecycle marketing with a focus on technical implementation (preferably in a B2B SaaS environment).
- Proficiency with at least one email marketing platform (e.g., Braze, HubSpot, or Salesforce Marketing Cloud).
- Understanding of B2B user journeys, audience segmentation using behavioral and lifecycle data.
- Familiarity with email deliverability best practices and KPI’s.
- Professional written and spoken English.
- Analytical mindset with the ability to interpret campaign performance data, run experiments, and translate insights into action.
- Familiarity with data analysis tools (Looker, Salesforce, or similar).

## Salary Range

Gross Salary 1900 - 2700 EUR/Month.
