<p>コマーシャル・セールス部門のチームマネージャーとして、中小企業をターゲットにした新規顧客（ロゴ）の開拓とクロージングに取り組むコマーシャル・アカウント・エグゼクティブたちに戦略やメンターシップを提供し、成功までの確実な道のりをハンズオンでリードします。Datadogにとって最大の事業分野のひとつで、長期的には、高い実績と評価を誇る Datadog 製品を数十億ドル規模の市場にもたらします。</p>
...
<li>チームメンバー（アカウント・エグゼクティブ）の採用と育成</li>
<li>アウトバウンド活動によるリードジェネレーションなどのセールス・アクティビティと、健全なパイプラインの作成・維持の促進</li>
<li>新メンバーの立ち上げをサポートし、成功まで導く</li>
<li>見込顧客から契約に至るまでのセールス・ファネルをモニタリングし、パフォーマンス改善のためのメトリクスを作成する</li>
</ul>
<p><strong>募集要項：</strong></p>
<ul>
<li>革新的なテクノロジーを有する企業での直販営業経験（SaaS、Cloud、インフラストラクチャーまたは類似の領域が望ましい）</li>
<li>クロージングを含めたアウトバウンドセールスチームをマネジメントした実績</li>
<li>チームメンバーの業績に対する正確なフォーキャスティング能力</li>
<li>コーチング、メンターシップ、チームマネジメントの重要性を理解している</li>
<li>継続的な学習意欲と、メンバーの成長をサポートすることへの高いモチベーション</li>
<li>成長速度が早く、変化の激しい市場で活躍するセルフスターター</li>
</ul>
...
<p><em>世界中のすべての候補者様にご理解頂けるよう、応募情報に関する項目は一部、英語のままで記載されています。全ての求人情報を英語でご確認されたい場合は、<a href="https://careers.datadoghq.com/detail/5661424/?gh\_jid=5661424">こちら</a>をご覧ください。</em></p>
