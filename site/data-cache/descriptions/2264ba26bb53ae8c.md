...
<ul>
<li>.This is an exciting time to join Remote and make a personal difference in the global employment space as a Manager, Business Operations&nbsp;joining our Payroll Business Operations Team.</li>
<li>As our Manager, Payroll PMO Manager, you will be responsible for building and lead the PMO function.</li>
<li>We love&nbsp;<a href="https://www.notion.so/80c01cd443ad4c77a8ceaef7c5fba5d0?pvs=21">working async</a>&nbsp;and this means you get to do your own schedule, no matter what timezone you're in.</li>
<li>We empower ownership and proactivity and when in doubt default to action instead of waiting..</li>
</ul>
<h2><strong>What you bring</strong></h2>
<ul>
<li>6+ years of experience in project management / implementations / professional services in the HRtech, fintech or software/technology industry;</li>
<li>Strong leadership, intellectual curiosity, analytical, and technical understanding of software systems at scale;</li>
...
<li>Superior verbal, written and presentation skills are necessary, as well as the ability to work effectively across internal and external organizations;</li>
<li>Experience in B2B SaaS technology partnerships;</li>
...
<li>Demonstrates&nbsp;<span class="discussion-id-2f7cb4da-dab4-80a4-a764-001c166909fc suggestion-update discussion-level-1 discussion-id-2f7cb4da-dab4-80bf-afa7-001c165870c4 notion-enable-hover" data-token-index="1">strong </span><span class="discussion-level-1 discussion-id-2f7cb4da-dab4-80bf-afa7-001c165870c4 notion-enable-hover" data-token-index="2">automation </span><span class="discussion-id-2f7cb4da-dab4-801d-830c-001cfca0393d suggestion-update discussion-level-1 discussion-id-2f7cb4da-dab4-80bf-afa7-001c165870c4 notion-enable-hover" data-token-index="3">and AI </span><span class="discussion-level-1 discussion-id-2f7cb4da-dab4-80bf-afa7-001c165870c4 notion-enable-hover" data-token-index="4">capabilities</span></li>
</ul>
<h2><strong>Key Responsibilities&nbsp;</strong></h2>
<ul>
<li>Develop and project manage a partner and customer’s integration architecture, implementation timeline, and operational work streams</li>
<li>Develop clear and accurate implementation guide</li>
<li>Lead the planning, tracking and completion of all project tasks throughout the partner and customer onboarding and implementation process — including but not limited to:
<ul>
<li>Develop and oversee the project schedule and lead regular meetings with operational leads</li>
<li>Document, coordinate and monitor progress of partner and customers, including ensuring all requirements are met</li>
<li>Coordinate internal resources as required; Drive project to release on time with high quality</li>
<li>Help partner, Product, Engineering and Payroll Operations teams understand product features and benefits</li>
</ul>
</li>
<li>Identify and understand project risks, coordinate with respective teams as applicable to mitigate and resolve</li>
<li>Contribute to the development of integration best practices, training material and Remote internal and external collateral</li>
<li>Manage the complexities of multi-step high-stakes projects with organization and efficiency and keen attention to deadlines</li>
<li>Communicate project plan, deployment progress, execution, and delivery using relevant reporting tools and dashboards</li>
<li>Collaborate closely with Product and Engineering on strategic projects that improve and scale our implementation process and team operations</li>
<li>You are passionate about team-work and developing people</li>
<li>Strong leadership, Coaching and Mentoring skills</li>
<li>Grow and develop the PMO function</li>
</ul>
<h2><strong>Practicals</strong></h2>
<ul>
<li><strong>You'll report to:</strong> <span class="notion-enable-hover" data-token-index="0">Director of Payroll Operations</span></li>
<li><strong>Direct reports:</strong> 3 ICs</li>
<li><strong>Team:</strong> Payroll Operations&nbsp;</li>
<li><strong>Location</strong>: For this position we welcome everyone to apply, but we will prioritize applications from the following locations as we encourage our teams to diversify; United Kingdom or EMEA.</li>
