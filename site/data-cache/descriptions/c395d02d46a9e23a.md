<p>Graphing Experience creates simple tools that enable all users to explore data and communicate insights through visualizations. As the Engineering Manager for the team, you will lead critical product initiatives that enable Datadog to grow its business.&nbsp;</p>
<p>You will define our technical vision and shape the product roadmap, working closely with product managers and engineers on the team. You will support growing the team, onboarding new hires and growing engineers to the next level. Your team will play a leading role in enabling new product use cases, improving user experience for different user personas, and building UIs for advanced data querying use cases.</p>
...
<ul>
<li>Manage and grow the Graphing Experience team, directly managing 5-7 engineers</li>
<li>Define our technical roadmap in alignment with product goals&nbsp;</li>
<li>Work with PMs and partner teams to make graphing UIs both easier to use and more powerful</li>
<li>Create a strong team culture aligned with our engineering standards and our customer focus</li>
<li>Ensure that team processes and practices are aligned with Datadog's engineering standards and best practices</li>
<li>Participate in code and design reviews to ensure that the team is delivering high-quality software</li>
</ul>
<p>&nbsp;</p>
<p><strong>Who You Are:&nbsp;</strong></p>
<ul>
<li>You have successfully led diverse and inclusive engineering teams, including onboarding and performance management</li>
<li>Excellent leader with strong interpersonal skills, and the ability to build and lead high-performing teams</li>
<li>Interested in addressing ambiguous business problems and figuring out the right short-term and long-terms plans to solve them</li>
...
<li>Strong technician, particularly with Typescript and React, who is interested in remaining a hands-on leader</li>
</ul>
