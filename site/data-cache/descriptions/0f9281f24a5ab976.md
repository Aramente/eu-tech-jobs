...
Low Level Server side Team is responsible for delivering VPN server software used by millions of users worldwide

## Main Responsibilities

- Design and develop production-grade solutions where correctness and latency are both non-negotiable in Rust, Go or C;
- Solve difficult problems in security, performance, privacy and networking at scale;
- Collaborate closely with Low-Level and SRE teams across the full lifecycle - from architecture decisions to production deployment.

## Core Requirements

- Habit of going deep - reading RFCs, tracking kernel changelogs, understanding the why behind the stack;
- Strong ownership mindset with the ability to independently lead and deliver software from conception to production;
- Solid software engineering knowledge in at least one strongly typed programming language ;
- Deep understanding of Linux operating system (firewalls, routing, networking, services, interrupts, etc.);
- Advanced knowledge of networking protocols - UDP, TCP, IP v4/v6, DNS, QUIC, TLS,  etc.
- Good debugging skills
- Experience with GitLab and understanding of core CI/CD principles;
- Actively contributes to team knowledge through code reviews, documentation, and mentoring;
...
- eBPF;
- Knowledge of VPN protocols WireGuard, OpenVPN;
