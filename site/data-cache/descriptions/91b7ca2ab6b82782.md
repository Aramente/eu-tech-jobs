...
<p>As a Senior Order Management Analyst, you will play a critical role in ensuring the accuracy, efficiency, and integrity of Axon’s order-to-cash operations. You will independently manage complex process of bookings workflows while partnering cross-functionally with Sales, Finance, Fulfillment, Product, and Customer Success teams to deliver an exceptional customer experience.</p>
<p>Location: UK (London or Daventry Office).&nbsp; <strong>Requires in-office 4 days a week (Tuesday-Friday) with Mondays optional remote.&nbsp;</strong></p>
<p>Reports to: Director, Order Management</p>
<h3>What You’ll Do</h3>
<ul>
<li>Independently manage end-to-end order processing including order validation, booking, amendments, system corrections, and releases.</li>
<li>Review and interpret contracts, pricing structures, and commercial terms to ensure accurate order entry and revenue integrity.</li>
<li>Resolve complex order issues impacting bookings, fulfillment, invoicing, or compliance.</li>
<li>Partner with Sales, Sales Operations, Finance (AR), Warehouse, and Product teams to remove blockers and drive timely fulfillment.</li>
<li>Monitor backlog and backorders; proactively coordinate release activities and customer communication.</li>
<li>Perform internal audits and quality checks to ensure compliance with revenue controls and operational standards.</li>
<li>Drive continuous improvement initiatives, including automation and workflow optimization.</li>
<li>Deliver process training and mentor junior analysts to elevate team capability.</li>
<li>Contribute to pipeline reviews and provide operational insight that supports revenue forecasting.</li>
</ul>
<h3>What You Bring</h3>
<ul>
<li>7+ years of experience in Order Management, Revenue Operations, or Order-to-Cash environments.</li>
<li>Proven ability to independently manage complex global transactions with minimal supervision.</li>
<li>Strong understanding of revenue controls, audit requirements, and booking compliance.</li>
<li>Advanced proficiency in ERP and CRM systems (e.g., Salesforce, D365, SAP, NetSuite, or similar).</li>
<li>Strong analytical skills and experience using reporting tools (Excel, Sigma, or similar platforms).</li>
<li>Ability to influence cross-functional stakeholders and drive resolution in ambiguous situations.</li>
<li>Continuous improvement mindset with experience implementing process enhancements or automation.</li>
<li>Operates with minimal supervision and high autonomy</li>
<li>Makes independent decisions impacting bookings, revenue, and customer satisfaction</li>
<li>Serves as a subject matter expert within Order Management</li>
<li>Influences department-level outcomes through expert contributions</li>
<li>Plays a key role in mentoring and developing peers and junior team members</li>
</ul>
<h3><strong>Work Location</strong></h3>
<p>This role is based out of our UK office and follows a hybrid schedule. We rely on in-person collaboration and ask that team members work onsite Tuesdays through Fridays, with the flexibility to work remotely on Mondays, unless there is an approved workplace accommodation. We believe that connection fuels innovation, and our in-office culture is designed to foster meaningful teamwork, mentorship, and shared success.<br><br></p>
