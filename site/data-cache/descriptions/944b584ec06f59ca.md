...
Dans une organisation commerciale en pleine croissance en France et à l’international, et dont la complexité augmente chaque année, tu seras le partenaire analytique privilégié du VP Sales, des Head of Sales et des managers. Ton rôle est de fournir une intelligence commerciale fiable et actionnable, permettant un pilotage précis, des décisions stratégiques éclairées et l’optimisation de la performance des équipes. Contrairement au RevOps, ton focus n’est pas sur l’exécution ou l’automatisation des processus, mais sur l’analyse, le suivi et l’optimisation des KPI et du funnel commercial, pour sécuriser la croissance et maximiser l’impact des décisions.

## Missions 🛠

Le poste se divise en 7 axes stratégiques :

1. Pilotage de la Performance (Governance)

2. Business Intelligence & Dashboards

3. Analyse de Données & Insights Stratégiques

4. Optimisation des Ressources & Productivité

5. Pilotage de Projets de Transformation

6. Support au Leadership Commercial

7. Exécution & Fluidité Opérationnelle

## Ideal Profil 👀

## Parcours et Compétences Techniques

- **Expérience :** 3 à 4 ans en cabinet de conseil en stratégie (Top Tier) ou en Scale-up sur des rôles de Business Operations / Strategic Sales.
- **Outils :** Maîtrise **indispensable** et avancée de **Salesforce** et des outils de BI (Tableau, Looker, Metabase, etc.).
- **Analytique :** Capacité à modéliser des problématiques complexes et à maîtriser les metrics SaaS (Forecast, Conversion, CAC/LTV).

## Soft Skills & Mindset

- **Capacité d'exécution :** Ne se limite pas à l'analyse ; sait "mettre les mains dans le cambouis" pour faire avancer les projets.
- **Résilience :** Très à l'aise dans l'incertitude, le flou et les environnements à haute pression.
- **Communication :** Capacité d'influence auprès de profils de haut niveau; bonne capacité de synthèse écrite.
- **Langues :** Bilingue Français / Anglais (contexte international).
