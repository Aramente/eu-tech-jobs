...
- Own your revenue targets and drive sales.
- Run the full sales cycle from discovery to close.
- Hunt, build, and maintain a healthy pipeline of high-potential clients.
- Refine outbound workflows and contribute to team projects that improve performance.
- Attend industry events and conferences to expand your network and source new opportunities.
- Work closely with SDRs - receive leads, give feedback, and help them generate more pipeline for you.

## Core requirements

- 2+ years of outbound sales experience, ideally in tech or SaaS.
- Proven track record of hitting targets and closing deals.
- Comfortable running enterprise deals with multiple stakeholders and complex buying groups.
- Experience working with Salesforce, LinkedIn Sales Nav, Gong, Apollo, Clay, or other similar modern sales tools.
- Ability to learn and speak confidently about technical concepts in cybersecurity.
- Strong negotiation, presentation, and objection-handling skills.
- Able to lead and own internal projects and initiatives and internal projects for better sales team performance.
- Fluent in English.

## Salary Range

- Gross Salary 2800- 3700 EUR/Month. Bonuses based on results achieved.
