...
- Design well-structured test cases and create automated tests to identify product issues (business requirements' implementation in feature, behavior, and performance);
- Take ownership of test automation process during releases;
- Work on smoke and regression testing;
- Work on testing strategy improvement;
- Participate in feature planning and estimation with the development team;
- Ensure that the product is at a high-quality level and prepared for deployment.

## Core Requirements

- You have 3+ years of experience in software testing automation and OOP programming knowledge (C# would be a plus);
- You can design, automate test cases, and you know a variety of testing techniques;
- You have done smoke and regression testing and have been responsible for automation during releases, also test maintenance;
- You can predict potential future bugs during the feature planning phases;
- You are an attentive to detail problem-solver, who communicates effectively with the team;
- Experience in automated testing with desktop applications would give you huge extra points.

## Tools You Will Use

- Experience with source control - Git;
- Previous experience with any testing frameworks (Bonus points: WinAppDriver, FlaUI, Nunit);
- CI/CD integrations with GitLab, GitHub or Jenkins;
- Visual Studio, Visual Studio code, Git Bash, Microsoft Inspect.

## Salary range

- Gross Salary 3300 - 5800 EUR/Month.
