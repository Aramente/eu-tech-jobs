...
The Desktop Applications department is a collaborative team of passionate and talented engineers focused on developing cutting edge secure networking cybersecurity solutions for businesses. We build on each other's ideas with security in focus and solve complex problems.

## Main Responsibilities

- You will have a great team to mentor you: skilled Windows, Linux, macOS and mobile engineers
- You will also be collaborating with designers, QA, and Product Owner, to extend and improve the functionality of our product
- You will work on Windows development - Services, IPC, networking, GUI, APIs, drivers
- Mentor others and share your expertise team-wise.

## Core Requirements

- Proven Experience: minimum 3+ years of experience in Windows application development using .NET
- Windows API Proficiency: deep familiarity with Windows API, including experience with multithreading, inter-process communication, and memory management
- Debugging & Troubleshooting: excellent debugging and troubleshooting skills with experience using Windows debugging tools
- Experience in Agile & Git
- Profound English language skills.

## Bonus Points For

- Good understanding of networking protocols (TCP/IP, UDP), VPN technologies (OpenVPN, WireGuard, IPSec), and network security principles
- Good understanding of security best practices and a commitment to writing secure code.
