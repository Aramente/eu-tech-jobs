...
We’re opening our doors to **talented junior engineers** - because impact isn’t measured in years of experience. It comes from your drive to learn, your discipline, and a sharp mind. It’s about building and shaping what’s around you - and Saily will give you the room to do exactly that.

What can you expect from us? Hands-on experience with AI-assisted software development, shared openly. Full freedom to use whatever learning resources you need to keep up. A product that’s successful, impactful, and technically challenging - something you’ll actually want to build.

Pack your skills, bring your vision, and join **Saily**!

## Main Responsibilities

- Delivers small tools/features with support from the team.
- Collaborate with product, design, and other engineers.
- Operate in small, highly autonomous teams.
- Learn how to use AI agents for specs, coding, analysis, testing, and iteration.
- Take part in the improvements of our internal agent network and development workflows.
- Focus on user and business outcomes, not output.

## Core requirements

- 1+ year of software development experience building something real (product, system, tool, startup, side project, meaningful feature, or student project)
- You value autonomy over stability and process
- You enjoy working across layers instead of staying in one box
- You think in problems and outcomes, not tickets
...
Gross salary: 18,100 — 24,400 PLN / month
