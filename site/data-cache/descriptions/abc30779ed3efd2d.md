...
<p>As an Enterprise Account Executive, Telecommunications based in Tokyo, you'll drive the adoption of safe, frontier AI technology across Japan's government and Telecommunications organizations. You'll own the full sales cycle from prospecting to closing, working with senior leaders to help them modernize the Telecommunications industry and operations with Anthropic's AI solutions.</p>
<h2><strong>Responsibilities:</strong></h2>
<ul>
<li>Own and exceed revenue targets by winning new major Telecommunications accounts and expanding existing relationships across Japan's government entities and Telecommunications</li>
<li>Build and execute territory plans, identifying high-value opportunities across national government ministries, prefectural and municipal governments, and quasi-governmental organizations</li>
<li>Lead consultative sales processes with senior government officials, procurement leaders, and technical stakeholders, positioning AI as a driver for digital government transformation and improved citizen services</li>
<li>Orchestrate internal teams (Product, Engineering, Applied AI, Partnerships) to deliver solutions that meet stringent security, compliance, and procurement requirements</li>
</ul>
<h2><strong>You may be a good fit if you have:</strong></h2>
<ul>
<li>8+ years of enterprise sales experience in Japan with significant exposure to Telecommunications sector accounts, driving adoption of emerging technologies with a consultative, solutions-oriented sales approach</li>
<li>A track record of managing complex, long-cycle sales processes and securing strategic deals with government entities by understanding Telecommunications sector procurement requirements and crafting compliant solutions</li>
<li>Demonstrated ability to navigate Telecommunications stakeholder ecosystems, building consensus across multiple departments, budget authorities, and approval layers</li>
<li>Proven experience exceeding revenue targets by effectively managing pipeline across different government fiscal timelines</li>
...
<li>A strategic, analytical approach to identifying opportunities within Japan's Telecommunications sector combined with patient, relationship-focused execution</li>
<li>A passion for and/or experience with advanced AI systems. You feel strongly about ensuring frontier AI systems are developed safely and responsibly for public benefit</li>
