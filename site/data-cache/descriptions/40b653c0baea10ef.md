...
<ul>
<li>Extensive experience of global or regional payments experience, with focus on Operations</li>
<li>Has successfully led bank integration projects via API or host-to-host connectivity, &amp; implementation of automated payment files in ISO 20022 XML format</li>
<li>Deep knowledge of banking regulations surrounding payment requirements across the globe</li>
<li>Proven inspiration and forward-thinking to take ownership of project from discovery to resolution, set ambitious business goals, drive results, and meet tight deadlines</li>
<li>Balance attention to detail with swift execution - we need to do things quickly, and we need to do them well. Balancing those can be challenging, and this should be a strength of yours</li>
<li>Proven ability to autonomously resolve complex payment issues</li>
<li>Proven ability to highlight outstanding organization skills &amp; going above &amp; beyond in execution which are critical to be successful in this role</li>
<li>Exceptional ability to communicate and foster positive business relationships</li>
<li>Ability to establish milestones and keep all team members on task</li>
<li>Experience in a high-growth start-up or large multi-national preferred</li>
...
<ul>
<li>Manage daily payment tasks and flow. Be the main contact for payment processing rules in various countries. Help Sales and other teams with banking or payment provider issues.</li>
<li>Own global payment execution, ensuring payments to employees and contractors are processed precisely and timely</li>
<li>Own the research and resolution of payment reconciliation discrepancies on a daily basis</li>
<li>Lead integration effort with banking partners and payment providers. Operationalize new payment method execution</li>
<li>Serve as escalation point on complex payment issues and ascertain processes are in place to minimize the number of payment processing issues</li>
<li>Drive process improvements and efficiency solutions including automation of daily operations workflow processes</li>
<li>Develop tools/metrics and dashboards to track performance of payments metrics</li>
<li>Collaborate across multiple teams including Payroll, Product, Engineering, Customer Success and Finance</li>
<li>Keep abreast of the latest innovations in the Payments and Compliance space. Help identify new sources of data that can allow Remote to route payments globally using the most cost-effective method.</li>
</ul>
<h2><strong>Practicals</strong></h2>
<ul>
<li><strong>You'll report to:</strong> Director, Payments Operations</li>
<li><strong>Team:</strong> Operations - Payments</li>
...
<li>Technical Assessment (async)</li>
