...
<p>Remote is hiring a <strong>Senior Staff Product Designer</strong> to be one of the strongest individual contributors in the company. This is a craft-first, systems-minded role for someone who likes the messy problems: ambiguity, scale and real-world constraints.</p>
<p>You’ll shape how we build product at Remote: the patterns we repeat, the systems we rely on, and how we use AI and prototyping to move from idea to something real. You’ll take on company-wide initiatives, special projects with high visibility, and help push our all of our products forward.</p>
<h2>Key responsibilities</h2>
<ul>
<li><strong>Prototype like it matters.</strong> You’ll lead by showing, not telling. High-fidelity prototypes, functional flows, code when it helps, AI when it speeds up exploration. You’ll bridge vision and feasibility without losing craft.</li>
<li><strong>Build systems that scale.</strong> Spot patterns before they fragment. Create reusable frameworks and abstractions that keep the product coherent across domains and teams.</li>
<li><strong>Make AI useful, not gimmicky.</strong> Help the org use AI in practical ways: faster exploration, better documentation, tighter workflows, less busywork. Set the standard for what “good” looks like.</li>
<li><strong>Influence across the company.</strong> Partner with execs and VPs on direction and experimentation. Navigate complexity, align teams, and keep the work grounded in user value.</li>
<li><strong>Raise the bar.</strong> Mentor at a mastery level. Shape rituals, playbooks, and how we critique work so design quality consistently goes up.</li>
</ul>
<h2>What you bring</h2>
<ul>
<li><strong>Leader scope and judgment.</strong> You’re strong across user centricity, craft, vision, communication, and leadership as an IC.</li>
<li><strong>Serious craft.</strong> Your portfolio shows excellent interaction + visual design. You can design without a system or create a system from your designs.</li>
<li><strong>Technical depth.</strong> You know how to prototype for real, build for scale, and sweat performance and details. You’re fluent with AI-assisted design.</li>
<li><strong>You’re good in the undefined.</strong> You can take a vague goal and turn it into a concrete, high-quality product direction with minimal hand-holding.</li>
<li><strong>Strong communicator.</strong> Clear, strong storytelling, and the ability to bring people along without turning it into theatre.</li>
</ul>
<h2>Practicals</h2>
<ul>
<li><strong>You'll report to:</strong> VP, Design</li>
<li><strong>Team:</strong> Design</li>
<li><strong>Team size:</strong> This is an individual contributor role</li>
...
<p>Roughly 5-6 hours across 5 weeks</p>
<ol>
<li>Interview with recruiter</li>
<li>Interview with future manager</li>
<li>Async case study presentation (craft + prototyping)</li>
<li>Team / cross-functional interview</li>
