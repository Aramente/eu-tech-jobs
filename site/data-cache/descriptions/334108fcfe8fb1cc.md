...
<div>&nbsp;</div>
<div><span style="font-size: 12pt; font-family: helvetica, arial, sans-serif;">If you are energetic, curious, motivated and ambitious, be part of our world. Apply now and define the future of work!</span></div></div><h2><strong>What you bring</strong></h2>
<ul>
<li>Several years of work experience in regional / global payroll operations, including experience within Italian staffing agencies (APL).</li>
<li>Ability to manage risk and exercise judgement to resolve/escalate issues. Exercise discretion when handling confidential matters.</li>
<li>Understanding of global payroll best practices.</li>
<li>Experience in implementing payroll in multiple countries and in managing relationships with third party payroll services.</li>
<li>Proficient in using software tools like SAP, Excel / Google Sheet, and Zucchetti Paghe Project.</li>
<li>Proven experience as Payroll Expert, with extensive knowledge of the payroll function including preparation, balancing, internal control, and payroll taxes, within an APL context.</li>
...
<ul>
<li>The Payroll Country Lead will own the complete Country Pod of the APL, ensuring payroll is processed on time, accurately, and in compliance with country specific government regulations, you will provide guidance and mentorship to the team.</li>
<li>Serve as a point of contact between internal and external stakeholders on all payroll country related matters.</li>
<li>Be up to date with various international payroll laws / regulations/Tax and benefits.</li>
<li>Ensure compliance with all corporate and country-specific regulations, policies and procedures.</li>
<li>Manages existing relationships with payroll, accounting and payroll service providers, including staffing agencies (APL) and related stakeholders..</li>
<li>Develop and implement best practices, key performance indicators and SLA metrics for the team.</li>
<li>Ensure all relevant payroll processes are documented and maintained in line with internal governance requirements and external legislative/regulatory requirements, including GDPR.</li>
<li>Plan for, implement and review system development, statutory changes, and periodic processes. Support with testing for development/enhancements to Payroll system, with specific focus on Zucchetti Paghe Project where applicable.</li>
</ul>
<h2><strong>Practicals</strong></h2>
<ul>
<li><strong>You'll report to: </strong>Payroll Operations Manager</li>
<li><strong>Team:</strong> Payroll Operations</li>
<li><strong>Location</strong>: For this position we welcome everyone to apply, but we will prioritize applications from the following locations as we encourage our teams to diversify; Italy</li>
<li><strong>Start date:</strong> As soon as possible</li>
</ul>
<h2><strong>Application process</strong></h2>
<ol>
<li>Interview with recruiter</li>
<li>Interview with payroll managers</li>
