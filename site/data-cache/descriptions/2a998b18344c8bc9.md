...
<p>We are looking to bring on a Principal Product Manager for AI within our Observability team, where you'll drive the vision and execution of AI-powered features across our Observability platform. You'll shape how Agentic AI, Machine Learning, LLMs, and semantic context transform the entire observability lifecycle - from data onboarding and enrichment to advanced root cause analysis, impact assessment, and automated remediation. This is a high-impact role that will help shape our product offering.</p>
<h3><strong>What You Will Be Doing</strong></h3>
<ul>
<li>Define and execute the AI strategy for Observability, leveraging Elastic's AI stack (Elastic Inference Service, Elastic’s Agent Builder, AI Assistant, RAG, Vector Search, Knowledge Bases, NLP).</li>
<li>Own the roadmap for embedding AI and ML into log analytics, incident investigation, and SRE workflows.</li>
<li>Partner with Engineering, UX, and cross-functional teams to deliver seamless, intuitive AI-driven experiences.</li>
<li>Collaborate with our Sales and Marketing teams to drive adoption, enablement, and go-to-market for new AI features.</li>
<li>Engage with customers and the field to gather feedback, validate solutions, and iterate quickly.</li>
<li>Track industry trends and competitive landscape to ensure Elastic leads in AI-powered Observability.</li>
</ul>
<h3>What You Bring&nbsp;</h3>
<ul>
<li>&nbsp;5+ years in product management or a related field, with a focus on AI, ML, or Observability.</li>
<li>Deep understanding of AI/ML technologies (LLMs, RAG, NLP, semantic search) and their application to real-world problems.</li>
<li>Experience building and shipping data-intensive or AI-driven products at scale.</li>
<li>Strong technical acumen and ability to translate complex AI concepts into user value.</li>
<li>Excellent communication and collaboration skills; able to influence across teams and functions.</li>
<li>Passion for innovation, customer empathy, and a bias for action.</li>
