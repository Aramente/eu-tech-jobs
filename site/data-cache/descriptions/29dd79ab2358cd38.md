...
Pyka is looking for a Senior Software Engineer to own the end-to-end development of our Ground Control application — a real-time Qt/QML system that is central to aircraft operations. This role spans UX design, frontend and backend implementation, and system-level integration. You’ll take an evolving, mission-critical tool and shape it into a reliable, intuitive, and high-performance product used in real-world flight operations. If you’ve built software for complex systems — vehicles, robotics, or industrial platforms — and care equally about usability and robustness, this is a chance to own a product that directly impacts how humans interact with autonomous aircraft.

## Responsibilities

- Take full ownership of Plane View, our core Qt/QML ground control application, and other human-machine interfaces
- Design and implement intuitive, high-performance user interfaces for real-time systems
- Own the full stack behind the application, including backend logic, data flow, and system behavior
...
- Define and uphold interface standards, visual consistency, and usability across the product
- Collaborate with a multidisciplinary team to evolve the architecture and capabilities of the system
- Serve as a key voice in product usability and workflow design

## Preferred Qualifications

- 5+ years of experience in software engineering, ideally with experience owning complex, user-facing systems
- Strong experience with Qt (bonus points for QML)
...
- 165,000-196,000 per year base salary + equity. Compensation will vary depending on location, job-related knowledge, skills, and experience. Salary ranges are subject to change.
