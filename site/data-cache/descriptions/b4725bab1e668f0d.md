...
<p>This is an opportunity to build foundational payroll expertise in a fast-scaling, global environment. As a Payroll Operations Coordinator - Americas, you’ll support the accurate and compliant execution of payroll across multiple regions in the Americas ensuring employee data is clean, complete, and ready for processing according to established guidelines.</p>
<p>This role is critical to payroll quality. You will operate at the intersection of data integrity, compliance, and execution — supporting payroll teams to run smoothly and on time.</p>
<p></p>
<h2><strong>What you bring</strong></h2>
<ul>
<li>Entry-level career experience in a payroll administration or HR operations role</li>
<li>High attention to detail — you catch inconsistencies others miss.</li>
<li>Strong data handling skills; comfortable working in spreadsheets (Excel / Google Sheets).</li>
<li>An analytical mindset with the ability to investigate and resolve data discrepancies.</li>
<li>Ability to follow structured processes while identifying opportunities to improve them.</li>
<li>Comfortable working in a fast-paced, cross-functional, and globally distributed environment.</li>
<li>Clear and concise communication skills in English.</li>
<li>Strong sense of ownership — you take responsibility for data accuracy and task completion.</li>
</ul>
<p><strong>What’s nice to have:</strong></p>
<ul>
<li>Exposure to payroll concepts, employee data management, or compliance requirements.</li>
<li>Experience working with HRIS, payroll systems, or ticketing tools.</li>
<li>Experience working remotely and across both the North American and Latin American markets</li>
</ul>
<p><strong></strong></p>
<h2><strong>Key Responsibilities&nbsp;</strong></h2>
<ul>
<li>Maintain and validate employee payroll data within internal systems, ensuring accuracy, completeness, and audit readiness <em><strong>against defined procedures</strong></em>.</li>
<li>Perform structured data checks and reconciliations to identify and resolve discrepancies ahead of payroll processing.</li>
<li>Partner closely with Payroll Specialists and Managers to support payroll cycle readiness across Americas countries.</li>
<li>Execute recurring operational tasks tied to payroll inputs (e.g. data updates, reporting support, expense management, mail management, and document validation).</li>
<li>Support internal stakeholders (e.g. Benefits, Finance, Onboarding) to ensure data flows correctly into payroll.</li>
<li>Track and manage tasks through internal workflows and ticketing systems, ensuring SLAs are met.</li>
<li>Contribute to documentation and standard operating procedures to improve consistency and scalability.</li>
<li>Identify inefficiencies and propose improvements to streamline payroll operations and reduce manual effort.</li>
</ul>
<p></p>
<h2><strong>Practicals</strong></h2>
<ul>
<li><strong>You'll report to:</strong> Manager, Payroll Operations</li>
<li><strong>Team:</strong> Payroll Operations - Americas</li>
<li><strong>Location</strong>: LATAM</li>
