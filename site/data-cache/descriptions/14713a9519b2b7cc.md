...
- Design, maintain, and execute manual test cases for a Windows-based desktop application;
- Test critical application functionalities, including components related to installation, updating, and integration within the Windows environment;
- Participate in the full testing lifecycle: analyze requirements, prepare test cases, and conduct regression testing;
- Investigate and document defects, offering actionable recommendations to prevent similar issues in future releases;
- Drive the development and execution of quality improvement strategies across the product;
- Own and manage the regression test backlog: create, prioritize, and continuously refine test suites for each release cycle, using a risk-based approach to ensure maximum coverage where it matters most;
- Engage actively in our QA Guild community by sharing insights, showcasing new techniques, and contributing to collective quality standards and best practices.

## Core Requirements

- At least 3+ years of experience in manual software testing;
- Advanced knowledge of test design and a variety of testing techniques;
- Strategic thinking and the ability to see the bigger picture of the whole product from a business perspective and processes;
- Deep analytical and problem-solving skills;
- Work hand in hand and effectively communicate with the team;
- Excellent written and spoken English skills.

## Bonus points

- Logging & Debugging: Windows Event Viewer, log analysis tools
