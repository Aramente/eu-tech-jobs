...
- Support testing and optimization tasks across digital channels;
- Help create and run simple A/B tests;
- Assist in analyzing user behavior and performance data;
- Monitor landing page performance and spot improvement opportunities;
- Help prepare ideas for improving engagement and conversion;
- Support landing page wireframes and basic UX improvements;
- Work with different teams (content, dev, analytics);
- Assist in reporting results and insights.

## Core Requirements

- Interest in digital marketing, optimization, or user behavior;
- Basic understanding of data, analytics, or A/B testing;
