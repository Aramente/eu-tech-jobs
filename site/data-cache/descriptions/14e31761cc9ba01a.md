...
- Manage the entire lifecycle of macOS/iOS devices, from deployment to retirement.
- Develop and implement scripting solutions for macOS/iOS automation and management.
- Oversee Identity and Access Management (IAM) integrations and policies for macOS/iOS.
- Ensure the security and compliance of all macOS/iOS endpoints.
- Drive automation and process improvements for endpoint management workflows.
- Strategically align macOS/iOS infrastructure with business and security objectives.
- Provide advanced support and guidance for macOS/iOS-related technical challenges.
- Collaborate with various teams to maintain a robust and efficient IT infrastructure.

## Core Requirements

- At least 1+ year of experience in a similar position with macOS devices
- Proficient in scripting languages for macOS (Bash, Zsh)
- Knowledge of macOS system architecture, security frameworks, native tools and experience with Configuration Profiles (mobileconfig) creation and deployment
- Hands-on experience with MDM platforms (JumpCloud, Jamf Pro, Kandji, Mosyle, or similar),
- Knowledge of identity and access management systems (Okta, JumpCloud, GWS or other)
- Familiarity with automation platforms and workflow tools (n8n or similar)
- Experience with API integrations between security, identity, and management systems
- Understanding of macOS security hardening and CIS benchmarks
- Experience designing and implementing device lifecycle management workflows
...
- Proficient in scripting languages for macOS (Python, Swift)
- Cross-platform endpoint management experience (Windows, Linux)
- Understanding of networking fundamentals and VPN technologies
- Experience with cloud platforms (AWS, GCP, Azure) for identity federation
- Experience with Google Workspace admin and endpoint integration

## Salary Range

- Gross Salary: 2300 - 3600 EUR/Month
