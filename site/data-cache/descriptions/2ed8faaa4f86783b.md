...
- Build a completely new sophisticated microservices system for the new eSim Product
- Create features to support layers of multi-dimensional personalization, A/B experimentation, and analytics.
...
- Experience working with Go (4+ years)
...
- Previous experience with SQL (MySQL, PostgreSQL) and NoSQL (Cassandra, Redis) solutions
