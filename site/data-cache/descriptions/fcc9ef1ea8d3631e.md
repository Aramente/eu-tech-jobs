...
<ul>
<li>The Finance Systems Data Analyst plays a key role in supporting the Finance organization by ensuring the accuracy, consistency, and accessibility of financial data across SAP and Snowflake environments.</li>
<li>This position bridges finance, data engineering, and business intelligence, helping to optimize data flows, automate reporting, and enable better financial decision-making through clean, connected data.</li>
</ul>
<h2><strong>What you bring</strong></h2>
<ul>
<li><strong>Essential:</strong>
<ul>
<li>Previous experience working with finance data as a systems analysts or data analyst&nbsp;</li>
<li>Strong SQL skills for data modelling &amp; transformations.</li>
<li>Experience with dbt or similar analytics engineering frameworks for building maintainable data pipelines</li>
<li>Experience integrating data from SAP to Snowflake or similar cloud data platforms.</li>
<li>Proficiency in financial data analysis, reporting, and visualization (Power BI, Tableau, or similar).</li>
<li>Solid understanding of accounting principles and financial reporting requirements.</li>
</ul>
</li>
<li><strong>Desirable:</strong>
<ul>
<li>Experience with <strong>Python</strong> or <strong>DBT</strong> for data automation.</li>
<li>Exposure to <strong>SAP S4 Hana</strong></li>
<li>Understanding of <strong>SAP Finance modules</strong> (FI, CO, AR, AP, GL) and underlying data structures.</li>
<li>Hands-on experience with Snowflake, including writing advanced SQL for data modeling and transformation</li>
</ul>
</li>
</ul>
<h2><strong>Key Responsibilities&nbsp;</strong></h2>
<ul>
<li><strong>Data Management &amp; Integration</strong>
<ul>
<li>Maintain, validate, and reconcile financial data between SAP (FI/CO, AR, AP, GL, etc.) and Snowflake data warehouse.</li>
<li>Skilled in transforming and modeling the data in dbt which is our de facto modeling layer</li>
<li>Collaborate with IT and Data Engineering teams to ensure accurate and timely data ingestion from SAP to Snowflake.</li>
</ul>
</li>
<li><strong>Finance Systems Support</strong>
<ul>
<li>Support finance users in troubleshooting data or system issues within SAP and Snowflake-based dashboards.</li>
<li>Participate in finance system upgrades, data migrations, or automation projects.</li>
</ul>
</li>
<li><strong>Reporting &amp; Analytics</strong>
<ul>
<li>Develop and maintain financial dashboards and reports (e.g., P&amp;L, balance sheet, cash flow, working capital KPIs) using SQL, Business Intelligence tools (example Sigma)</li>
<li>Translate business requirements into data queries and visualizations to support financial planning, audit, and compliance needs.</li>
<li>Deliver ad-hoc analysis and insights to support Finance leadership and other stakeholders.</li>
</ul>
</li>
<li><strong>Process Improvement</strong>
<ul>
<li>Identify and automate manual finance data processes to improve accuracy and efficiency.</li>
<li>Contribute to data governance frameworks, ensuring standardized definitions and consistent use of financial data across the organization.</li>
<li>Support ongoing digital transformation and data modernization initiatives.</li>
</ul>
</li>
</ul>
<h2><strong>Practicals</strong></h2>
<ul>
<li><strong>You'll report to:</strong> Manager, Finance Systems&nbsp;</li>
<li><strong>Team:</strong> Finance - Finance Systems</li>
<li><strong>Location</strong>: For this position we welcome everyone to apply, but we will prioritize applications from the following locations as we encourage our teams to diversify;</li>
...
<li>Technical challenge (async)</li>
<li>Technical challenge review (sync)&nbsp;</li>
<li>Interview with Senior Manager, Finance Systems.</li>
