...
<h4><strong>1. Enterprise Architecture &amp; Strategy</strong></h4>
<ul>
<li><strong>Architecture Design:</strong> Define the overall architecture, data, and cloud strategy for Celonis within the customer’s IT landscape. Ensure scalability, performance, and security across global deployments.</li>
<li><strong>Platform Governance:</strong> Establish architectural principles, policies, and standards. Lead or consult on Architecture Review Boards (ARB) to ensure Celonis remains a "Clean Core" extension of the customer’s ERP (SAP, Oracle, etc.).</li>
<li><strong>Modernization:</strong> Drive enterprise modernization by leveraging techniques like capability mapping and architecting solutions with emergent technologies (e.g., Agentic AI, Process Intelligence Graph).</li>
<li><strong>Integration Leadership:</strong> Design complex data pipelines (OCPM) and integration patterns (ETL/ELT, API ecosystems) that connect disparate systems into a unified Digital Twin of the business.</li>
</ul>
<h4><strong>2. Strategic Value Engineering</strong></h4>
<ul>
<li><strong>Executive Advisory:</strong> Confidently present technical designs and value realizations to CIOs, CFOs, and CTOs, aligning their strategic goals with Celonis' technical capabilities.</li>
<li>Work with senior stakeholders to establish the Celonis <strong>program roadmap</strong>.</li>
<li><strong>Resolve customer escalations</strong> orchestrating internal teams efficiently and effectively in a timely manner</li>
<li>Internalize the customer's strategy and targets and drive Celonis delivery alignment to that strategy, ensuring that we support the customer in <strong>solving business-critical problems</strong></li>
<li>Organize and lead customer advisory boards to address industry-specific challenges and <strong>innovations</strong>, establishing a structured feedback loop to continuously gather insights and improve products and services.</li>
</ul>
<h4><strong>3. Engagement Leadership</strong></h4>
<ul>
<li><strong>Single Threaded Lead:</strong> Mobilize and lead a multidisciplinary team of Applied AI engineers, Data Scientists, and Domain Experts. Ensure engagements are properly staffed leveraging resources from global cross-functional Celonis teams, such as Servicing, Product &amp; Engineering.</li>
<li><strong>Product &amp; Engineering Bridge:</strong> Act as the primary conduit between the customer’s technical teams and Celonis Product/Engineering to influence the product roadmap and resolve high-stakes technical blockers.</li>
<li><strong>Capability Building:</strong> Help the customer establish and scale a Celonis Center of Excellence (CoE), mentoring their internal architects and process leads.</li>
</ul>
<h3><strong>Technical Qualifications &amp; Experience</strong></h3>
<ul>
<li><strong>Experience:</strong> 12+ years in Enterprise Architecture or a CTO-level role at a major software vendor.</li>
<li><strong>Architecture Frameworks:</strong> Mastery of frameworks such as TOGAF or Zachman.</li>
<li><strong>Data &amp; Integration:</strong></li>
<ul>
<li>Hands-on experience with Big Data technologies (Spark, Kafka, Snowflake, Databricks).</li>
<li>Deep understanding of SaaS ecosystems (SAP S/4HANA, Salesforce, ServiceNow) and legacy on-premise architectures.</li>
</ul>
<li><strong>AI &amp; Innovation:</strong> Demonstrated experience in Agentic AI, Machine Learning workflows, and process mining methodologies.</li>
<li><strong>Security &amp; Compliance:</strong> Strong foundation in cybersecurity posture, data privacy (GDPR/CCPA), and SOC2/ISO compliance within cloud environments (AWS, Azure, GCP).</li>
<li style="font-weight: bold;">Strong proficiency in German</li>
<li>Preferred: Retail Industry Expertise</li>
</ul>
...
<p><strong>Enterprise Scaling:</strong> Accountability for the long-term success of some of the world’s largest business transformation projects.</p><div class="content-conclusion"><p><strong>What Celonis can offer you:</strong></p>
