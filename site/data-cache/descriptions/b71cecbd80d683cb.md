...
<ul>
<li>Manage, develop, coach and mentor Premier Support Engineers , Federal Support Engineerss] and/or people managers and their teams who respond to client requests, reproduce and troubleshoot issues, and dive into Datadog’s 400+ integrations</li>
<li>Act as the owner for your team’s accountability and performance - managing performance reviews, performance plans, and any employee relations issues for your direct reports</li>
<li>Partner with Support team senior leadership to oversee team projects and initiatives to improve productivity, process or procedure</li>
<li>Collaborate with internal teams and customers on high-priority escalations and act as a resource to resolve escalations from team members as necessary</li>
</ul>
<p><strong>Who You Are:</strong></p>
<ul>
<li>Passionate about people management and/or mentorship with previous experience leading a team, including managing other managers</li>
<li>Self-motivated, detail-attentive, and have a desire for continuous learning&nbsp;</li>
<li>A critical thinker who defaults to a client-centric approach and uses data to make informed decisions</li>
<li>A tinkerer with some programming experience and a basic knowledge of Linux</li>
<li>Active contribution to open-source projects (code, bug reports, etc.) and the Engineering Community (Meetups, etc.)</li>
</ul>
