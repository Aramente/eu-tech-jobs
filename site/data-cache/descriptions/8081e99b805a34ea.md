...
<p>You will be part of a critical team that designs technology that has a direct impact on increasing transparency and protecting truth. You will work with a team of talented software engineers, product managers and visual designers to create the mobile experience for our existing products. Your experience shipping mobile applications will allow you to rapidly innovate new and existing mobile applications and bring them to market. You will get the opportunity to build high quality applications using the latest mobile technologies available.<br><br>Our existing products are already well established in major agencies around the globe. Adding a mobile experience to these systems will unlock even more potential for new and existing customers. Get in early to create the foundation for the mobile experience. This role provides an awesome opportunity to work on our<a href="https://www.axon.com/products/axon-fleet-3"> Fleet 3 mobile</a>, <a href="https://play.google.com/store/apps/details?id=com.evidence.axon.devicemanager&amp;hl=en\_US">Axon Device Manager</a> and <a href="https://play.google.com/store/apps/details?id=com.axon.devicecheckout&amp;hl=en\_US">Device Pooling </a>Apps for phones and tablets. Check out <a href="https://www.youtube.com/watch?v=9a0-n-j13pI">this inspiring video</a> of fleet 3 tracking a Ferrari! <br><br>As part of our mobile team you’ll provide the team with guidance and direction to incorporate some of the latest Android technologies as we deploy our mobile apps to market.<br><br></p>
<h3>What You’ll Do</h3>
<p><strong><span data-usefontface="false" data-contrast="none">Work Location:&nbsp;</span></strong><span data-usefontface="false" data-contrast="none">This role is based out of our Ho Chi Minh Office and follows a hybrid schedule. We rely on in-person collaboration and ask that team members work onsite Tuesdays through Fridays, with the flexibility to work remotely on Mondays, unless there is an approved workplace accommodation. We believe that connection fuels innovation, and our in-office culture is designed to foster meaningful teamwork, mentorship, and shared success.</span></p>
<p><br><strong>Reports To:</strong> Engineering Manager</p>
<ul>
<li>Design, implement and maintain features within Axon Device Manager, Axon Device Check out and Fleet 3 Dashboard</li>
<li>Work across teams with Product, Design, and Engineering to create an integrated solution.</li>
<li>Focus on execution, set a high technical bar for the team through code and design reviews.</li>
</ul>
<h3>What You Bring</h3>
<ul>
<li>2 years of industry experience shipping Android applications to the Google Play Store.</li>
