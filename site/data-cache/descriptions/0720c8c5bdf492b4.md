...
- Design test automation frameworks (multi-platform) and write automated tests to conduct complex functional integration, regression, and performance tests to confirm that the acceptance criteria have been met
- Contribute to identifying testing strategies and drive their implementation
- Participate in writing test plans and test cases
- Report software defects and work with development team to resolve them
- Perform hands-on exploratory and manual testing to uncover edge cases and usability issues that automated tests may miss
- Validate complex user flows end-to-end across mobile and other platforms before major releases

**AI Adoption & Evangelism**

- Actively explore and integrate AI-powered tools into QA workflows to accelerate test creation, expand coverage, and reduce cycle times
- Champion the adoption of AI-assisted testing practices across the engineering organization
- Experiment with LLMs and AI assistants for generating test data, writing test cases from requirements, and triaging flaky tests
- Training and mentoring less senior team members in test automation would be very welcome

## Core Requirements

- 5+ years of experience in automated tests writing for web or mobile applications
- Experience in writing automated tests for REST API
- Experience working with Git and Docker
- Knowledge of Agile/DevOps best practices
- Experience working with JavaScript/TypeScript
- Experience working with one of the following automation
- frameworks: Jasmine, Jest, Mocha + Chai, Cypress, Playwright
- Passion for breaking things
- That you are sharp-eyed with attention to details
- Good written and spoken English skills

## Tools You Will Use

- **App:**  Appium with TypeScript on BrowserStack using GitLab
- **Web:** Playwright in TypeScript using Gitlab
- **BE:** Postman using Gitlab

## Salary Range

- Gross salary: 14,500 — 26,800 PLN/month
