...
<p>The Engineering Productivity team provides the foundation for Elastic teams to develop, build, test, and release their software at scale. We’re continuously evolving our platform and workflows, increasingly pushing boundaries toward Continuous Delivery, Continuous Quality models, while ensuring our Software Supply Chain is secured.</p>
<p>We're seeking a Principal Software Engineer to drive impactful projects in Engineering Productivity. Success in this role goes beyond your technical expertise and involves influencing outcomes through collaboration, effective stakeholder management, and strong communication.</p>
<p>&nbsp;</p>
<h3><strong>What You Will Be Doing</strong></h3>
<ul>
<li>Solve technical problems of the largest scope, complexity, and ambiguity.</li>
<li>Drive large, impactful projects that involve multiple stakeholders and impact many teams.</li>
<li>Represent Engineering Productivity to the rest of the company, gathering feedback and advocating for our projects and vision at different levels.</li>
<li>Up leveling the quality of the engineering in the org by setting standards exemplified in code review, incident response, and tech debt elimination for their team and peer teams.</li>
<li>Participate in the On-Call rotation.</li>
</ul>
<h3><strong>What You Bring</strong></h3>
<ul>
<li>A high level of autonomy - the distributed nature of the company offers freedom to work when and how you see fit, but also requires team members to work independently, and reach out for help when stuck.</li>
<li>Strong communicator who can tailor their message to engineering peers and leadership alike.</li>
<li>Supportive mindset to help grow and mentor other team members.</li>
<li>Effective at stakeholder management and influencing without authority.</li>
<li>Knowledge of Platform Engineering and CI/CD systems and practices (Buildkite, Backstage, Argo CD, GitOps, etc).</li>
<li>Familiarity and experience with Kubernetes.</li>
<li>Broad software development background and solid knowledge in either Go or Python.</li>
<li>Familiar with Linux and shell scripting.</li>
