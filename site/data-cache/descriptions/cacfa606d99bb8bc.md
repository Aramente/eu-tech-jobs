...
<div>&nbsp;</div>
<div><span style="font-size: 12pt; font-family: helvetica, arial, sans-serif;">If you are energetic, curious, motivated and ambitious, be part of our world. Apply now and define the future of work!</span></div></div><h2><strong>The position</strong></h2>
<p>This is an exciting time to join Remote and make a personal difference in the global employment space as a International Tax Analyst, joining our <strong>Finance</strong> team!</p>
<h2>Requirements</h2>
<ul>
<li>Collections professional with solid experience and proven performance, mainly consultancy environment</li>
<li>Prior experience with international taxation and financial operations</li>
<li>Experience with a global law firm, Fintech or start up company.</li>
<li>Negotiation and influencing skills.</li>
<li>Data driven communicator.</li>
<li>Professional experience working with large data sets.</li>
...
<ul>
<li>Assist with advisory projects on personal income tax and social security questions for all active countries</li>
<li>Determine and assess best equity options and payments</li>
<li>Moving forward work with the payroll department at determining the fund flow that will allow the tax efficiency regarding the salary packages and benefits in the different countries</li>
<li>Assess on local tax exposures in the different countries upon the ongoing (personal income tax and social security perspective)</li>
<li>Help the team with any tax question arising from clients</li>
<li>Build documentation resources to address recurring and potential customer questions around tax</li>
</ul>
