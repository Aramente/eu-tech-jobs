...
Our growth is driving us to strengthen our **AI Tribe** team to **lead our AI initiatives toward major technological challenges**.

Your mission will be to **oversee the AI "galaxy" (inference and beyond)** in order to **help the team deliver and act as a force for proposal within the current AI technological revolution**.
...
You will be part of a team of **11 people**. The AI Tribe is organized into three distinct teams supported by shared SRE resources, focusing on the "new eldorado" of cloud technology.

### **YOUR DAILY ROUTINE**

* Lead the AI Tribe toward ambitious technological milestones and product delivery
* Define and drive the strategic vision for AI products, including inference and emerging technologies
* Oversee the development of the "AI Galaxy," focusing on LLMs, agentic AI, and TUI (Text User Interface)
* Foster a culture of high ownership and agility within a rapidly growing team
* Act as a key technical advisor and proponent for innovative AI solutions
* Collaborate with Engineering Managers, Architects, and Tech Leads to ensure technical excellence
* Manage the organizational structure of three sub-teams and shared SRE resources
* Ensure alignment between the AI roadmap and Scaleway’s sovereign cloud objectives

### **ABOUT YOU**

💻 **HARDSKILLS**

* Extensive experience (10+ years) in software engineering and leadership roles
* Deep understanding of AI Inference and Large Language Models (LLMs)
* Knowledge of Agentic AI and TUI (Text User Interfaces)
* Experience managing large-scale, high-stakes engineering projects
* Familiarity with sovereign cloud requirements and SecNumCloud standards

🎯 **SOFTSKILLS**

* Strong strategic vision and ability to anticipate technological shifts
* Exceptional leadership and team empowerment skills (Ownership)
* High level of agility in a fast-paced, evolving environment
* Proactive mindset with a drive for innovation
* Excellent communication skills to align diverse technical teams
...
* **Interview with the Director of Engineering (DoE)** to understand your technical skills and approach to the role (45 min)
* **Interview with the Head of Engineering (HoE)** to validate your expertise (1h)
* **Interview with Engineering Managers, Architects, and Tech Leads** to deepen discussions and assess your fit with the team (45 min)
