<p>DatadogのSLED（State / Local / Education・自治体・教育機関・病院・大学/研究機関）セールスチームは、顧客が直面する現実的な課題を解決するベスト・イン・クラスのプロダクトを提供しています。セールス担当者は、顧客ごとの固有のニーズを的確に把握し、Datadogの価値を明確に伝えるための体系化されたセールスメソドロジーに基づいて活動します。トップセールスから学びたい方、またはトップセールスとして活躍したい方にとって、Datadogのセールスチームは個人の成長とチームの成功の両立を本気で支援する環境です。</p>
<p>私たちは、テクノロジーに強い情熱を持ち、チャレンジングな売上目標を達成できる経験豊富なSLEDセールスエグゼクティブを募集しています。Datadogがより大きな市場へ進出し、Public Sector（自治体・教育機関・病院・大学/研究機関）向けエンタープライズセグメントへの支援を本格化する中で、このポジションは組織成長を牽引する重要な役割を担います。新たなSLEDアカウントの開拓に加え、オンプレミスとクラウドのハイブリッド環境からクラウド移行を進める顧客とも関わることができる、非常に魅力的な機会です。<br><em><br></em><em>Datadogでは、オフィスカルチャーによって築かれる人間関係やコラボレーション、そこからもたらされる創造性を大切にしています。私たちは、従業員それぞれに合ったワーク・ライフ・ハーモニー（ワークライフバランス）を実現できるよう、ハイブリッド・ワークプレイス（ハイブリットな職場環境）として運営しています。</em></p>
<p><strong>業務内容：</strong></p>
<ul>
<li>自治体・教育機関・病院・大学/研究機関（SLED）の大規模組織に対するプロスペクティングと、効率的なセールスプロセスの実行</li>
<li>担当テリトリーにおける関係者マップの構築・管理（既存関係者および将来的なキーパーソン含む）</li>
<li>顧客ビジネスへの深い理解の構築</li>
<li>価値とROIを軸に、大規模SLED顧客との価格・契約条件の交渉</li>
<li>既存顧客の期待値をマネジメントしながら、担当テリトリー内での関係拡張・深耕</li>
<li>解決が容易でない課題に直面した際の高い問題解決力の発揮</li>
<li>クロージングに必要なステップを直感的に把握し、顧客の合意を獲得</li>
<li>すべての商談における価値ドライバーの特定</li>
<li>高い予測精度と一貫性のあるフォーキャスト管理</li>
</ul>
<p><strong>募集要項：</strong></p>
<ul>
<li>5年以上のクロージング経験をお持ちの方（SLED領域でのフィールドセールス経験を含む）</li>
<li>2～3年以上の官公庁／自治体／教育機関向けセールス経験</li>
<li>年間100万ドル以上の売上目標を達成・超過した実績があり、平均ディールサイズ10万ドル以上の取引経験</li>
<li>自らプロスペクティングし、パイプラインを構築できるセールスメソドロジーを持つ方</li>
<li>SaaS、ITインフラなど、革新的なテック企業での勤務経験（尚可）</li>
<li>大規模SLED組織に対する新規ロゴ獲得の実績</li>
</ul>
