...
<ul>
<li>A thorough knowledge of PostgreSQL is required. Working and hands-on experience with other SQL-based databases, Data Warehousing/ETL technologies like Informatica, DataStage, Oracle, Teradata, SQL Server, MySQL is desirable&nbsp;</li>
<li>Experience of at least one of the following :</li>
<ul>
<li>Designing, building, testing, and maintaining Python/Java/Scala based applications, with a thorough knowledge of python.</li>
<li>Developing with Spark and any of : Big Data, Hadoop, Machine Learning, Artificial Intelligence, Streaming, Kafka, Data Science, ElasticSearch</li>
</ul>
<li>Linux/Unix administration skills.</li>
<li>Hands-on experience with AWS, Azure or GCP.</li>
<li>Candidates must possess excellent English written and oral communication skills.</li>
<li>Experience with the "Distributed Big Data Computing" environment.</li>
